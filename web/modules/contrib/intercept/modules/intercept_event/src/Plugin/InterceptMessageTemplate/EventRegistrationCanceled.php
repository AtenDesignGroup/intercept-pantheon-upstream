...
/**
 * Provides message template for event registrations now canceled.
 *
 * @InterceptMessageTemplate(
 *  id = "registration_canceled",
 *  label = @Translation("Registration Canceled"),
 *  type = "event_registration"
 * )
 */
class EventRegistrationCanceled extends EventRegistrationMessageTemplateBase implements RecipientMessageTemplateInterface {
