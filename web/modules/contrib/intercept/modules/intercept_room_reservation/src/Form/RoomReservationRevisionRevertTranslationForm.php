...
class RoomReservationRevisionRevertTranslationForm extends RoomReservationRevisionRevertForm {
  ...
  /**
   * Constructs a new RoomReservationRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'room_reservation_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $room_reservation_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $room_reservation_revision);
