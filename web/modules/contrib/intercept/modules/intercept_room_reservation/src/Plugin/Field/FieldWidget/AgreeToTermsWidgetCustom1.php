...
class AgreeToTermsWidgetCustom1 extends BooleanCheckboxWidget {
  ...
  public static function isApplicable(FieldDefinitionInterface $field_definition) {
    ...
    $roles = $user->getRoles();
    return in_array('intercept_registered_customer', $roles) && $field_definition->getTargetEntityTypeId() === 'room_reservation' && $field_definition->getName() === 'field_agreement_custom1';
  }
