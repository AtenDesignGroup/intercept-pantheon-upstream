(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('redis'), require('crypto')) :
	typeof define === 'function' && define.amd ? define(['redis', 'crypto'], factory) :
	(global.interceptClient = factory(global.redis,global.crypto));
}(this, (function (redis,crypto) { 'use strict';
...
var failure = actionCreator(FAILURE, 'error', 'resource', 'id');

// Removes all local items and resets API syncing state;
var purge = actionCreator(PURGE, 'resource');
...
function isSymbol(value) {
  return (typeof value === 'undefined' ? 'undefined' : _typeof$6(value)) == 'symbol' || isObjectLike_1(value) && _baseGetTag(value) == symbolTag$1;
}
...
function baseIteratee(value) {
  ...
  if ((typeof value === 'undefined' ? 'undefined' : _typeof$8(value)) == 'object') {
  ...
  (function () {
    ...
    BottleneckError = function (_Error) {
      ...
      function BottleneckError() {
        _classCallCheck$1(this, BottleneckError);

        return _possibleConstructorReturn(this, (BottleneckError.__proto__ || Object.getPrototypeOf(BottleneckError)).apply(this, arguments));
      }
  ...
  (function () {
    ...
    Local = function () {
      ...
      _createClass$1(Local, [{
        ...
        value: function () {
          var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(incr) {
        ...
        key: '__check__',
        value: function () {
          var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(weight) {
            var now;
        ...
        key: '__register__',
        value: function () {
          var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(index, weight, expiration) {
            var _this = this;
        ...
        key: '__submit__',
        value: function () {
          var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(queueLength, weight) {
        ...
        key: '__free__',
        value: function () {
          var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(index, weight) {
  ...
  (function () {
    ...
    RedisStorage = function () {
      function RedisStorage(instance, initSettings, options) {
        ...
        _classCallCheck$3(this, RedisStorage);
      ...
      _createClass$2(RedisStorage, [{
        ...
        key: '__updateSettings__',
        value: function () {
          var _ref = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee(options) {
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
        ...
        key: '__incrementReservoir__',
        value: function () {
          var _ref4 = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(incr) {
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
        ...
        key: '__currentReservoir__',
        value: function () {
          var _ref5 = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
            return regeneratorRuntime.wrap(function _callee5$(_context5) {
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
        ...
        key: '__check__',
        value: function () {
          var _ref6 = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(weight) {
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
        ...
        key: '__register__',
        value: function () {
          var _ref7 = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(index, weight, expiration) {
        ...
        key: '__submit__',
        value: function () {
          var _ref10 = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(queueLength, weight) {
        ...
        key: '__free__',
        value: function () {
          var _ref13 = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(index, weight) {
            var result;
            return regeneratorRuntime.wrap(function _callee9$(_context9) {
              while (1) {
                switch (_context9.prev = _context9.next) {
      ...
      var Group = function () {
        ...
        _createClass$4(Group, [{
          ...
          value: function startAutoCleanup() {
            ...
            return typeof (base = this.interval = setInterval(_asyncToGenerator$2( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    Bottleneck = function () {
      var Bottleneck = function () {
        function Bottleneck() {
          ...
          _classCallCheck$6(this, Bottleneck);
          ...
          if (!(options != null && (typeof options === 'undefined' ? 'undefined' : _typeof$9(options)) === "object" && (arguments.length <= 1 ? 0 : arguments.length - 1) === 0)) {
        ...
        _createClass$5(Bottleneck, [{
          ...
          key: 'running',
          value: function () {
            var _ref2 = _asyncToGenerator$3( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
          ...
          value: function _run(next, wait, index) {
            ...
            completed = function () {
              var _ref4 = _asyncToGenerator$3( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                  args[_key] = arguments[_key];
                }
          ...
          value: function submit() {
            ...
            return this._submitLock.schedule(_asyncToGenerator$3( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
          ...
          key: 'updateSettings',
          value: function () {
            var _ref9 = _asyncToGenerator$3( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
              var _this7 = this;
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      _context6.next = 2;
                      return this._store.__updateSettings__(parser$$1.overwrite(options, this.storeDefaults));
          ...
          value: function () {
            var _ref10 = _asyncToGenerator$3( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
              return regeneratorRuntime.wrap(function _callee7$(_context7) {
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
          ...
          value: function () {
            var _ref11 = _asyncToGenerator$3( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {
              var _this8 = this;
...
var JsonApiSchema = function () {
  function JsonApiSchema(resource, schema) {
    _classCallCheck$7(this, JsonApiSchema);
...
var JsonApiModel = function JsonApiModel(schema) {
  ...
  _classCallCheck$7(this, JsonApiModel);
...
var Registrar = function () {
  function Registrar(name) {
    _classCallCheck$8(this, Registrar);
...
var EntityModel = function () {
  ...
  function EntityModel(type, bundle, schema) {
    _classCallCheck$9(this, EntityModel);
...
var apiRegistrar = new Registrar('api');
...
function processIncludes(dispatch) {
  return function (includes) {
    ...
    forEach_1(resources, function (records, resource) {
      dispatch(receive({ data: records.map(EntityModel.import) }, resource));
    });
  };
}
...
var ApiManager = function () {
  function ApiManager(options) {
    _classCallCheck$10(this, ApiManager);
  ...
  _createClass$9(ApiManager, [{
    ...
    value: function fetcher() {
      ...
      return {
        next: function next() {
          return _this.fetchAll(_extends$1({}, options, {
        ...
        function makeApiCall() {
          ...
          var fetchData = backoffFetch$$1(request$$1, responseHandler, errorHandler).then(function (resp) {
            ...
            if (resp.ok) {
              resp.json().then(function (json) {
                ...
                if (count === 0 || count > totalFetched) {
                  dispatch(_fetchAll(_extends$1({}, options, {
            ...
            //
                ...
                dispatch(failure(resp.status + ': ' + (resp.statusText || 'No status message provided'), resource));
              }
        ...
        function makeApiCall() {
          ...
          var fetchData = backoffFetch$$1(request$$1, responseHandler, errorHandler).then(function (resp) {
            ...
            //
                ...
                dispatch(failure(resp.status + ': ' + (resp.statusText || 'No status message provided'), resource, uuid));
              }
          ...
          return backoffFetch$$1(request$$1, responseHandler, errorHandler).then(function (resp) {
            if (resp.ok) {
              resp.json().then(function (json) {
                ...
                logger.log('network', 'Translation Response: ' + getTimestamp() + ' ' + options.langcode + ' ' + resource, json);
                logger.log('network', output.data);
                logger.groupEnd('network', 'response');

                dispatch(receiveTranslation(output, resource, options.langcode));
    ...
    value: function removeRelationship(relationship, uuid) {
      ...
      return function (dispatch, getState) {
        ...
        logger.log('network', method, request$$1);
    ...
    value: function sync(uuid, options) {
      ...
      return function (dispatch, getState) {
        ...
        if (saved) {
          assign_1(endpointParts, { id: uuid });
        }
        var endpoint = options.endpoint || _this5.getEndpoint(endpointParts);

        var request$$1 = getRequest(endpoint, _extends$1({}, options, {
          method: method,
          body: JSON.stringify(data)
        }));
    ...
    value: function getEndpointFields(fields) {
      ...
      return reduce_1(fields, function (query, value, key) {
        return assign_1(query, _defineProperty$2({}, 'fields[' + key + ']', value.join(',')));
      }, {});
    }
    ...
    value: function getRequest(endpoint) {
      ...
      if (options.body) {
        assign_1(requestOptions, { body: options.body });
      }
...
function itemEdit(item, data) {
  ...
  output.data = _extends$1({}, item.data, data);
  output.state = _extends$1({}, item.state, {
    error: null,
    dirty: true
  });
  return output;
...
function mergeProp(prop, x, y) {
  if (x[prop] || y[prop]) {
    return _extends$1({}, x[prop], y[prop]);
  }
}
...
function dataReducer() {
  ...
  switch (action.type) {
    case CLEAR_ERRORS:
      item.state = _extends$1({}, item.state, {
        dirty: item.state.dirty || item.state.error !== null || item.state.syncing || false,
        syncing: false,
        error: null
      });
