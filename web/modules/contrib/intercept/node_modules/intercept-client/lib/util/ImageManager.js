 ...
 * @type {EntityModel}
 */
var ImageModel = exports.ImageModel = function (_EntityModel) {
  ...
  _createClass(ImageModel, [{
    ...
    value: function _import(entity) {
      ...
      (0, _forEach2.default)(this.schema, function (value, key) {
  ...
  return ImageModel;
}(_EntityModel2.EntityModel);

exports.default = _EntityModel2.EntityModel;