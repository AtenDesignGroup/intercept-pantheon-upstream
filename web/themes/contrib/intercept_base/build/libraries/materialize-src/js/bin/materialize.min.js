...
function _possibleConstructorReturn(t, e) {
  ...
  function t(t, e) {
    ...
    if (!n) return this;if (n.cash && n !== T) return n;var o,
        a = n,
        r = 0;if (A(n)) a = R.test(n) ? O.getElementById(n.slice(1)) : P.test(n) ? e(n) : t(n, s);else if (I(n)) return i(n), this;if (!a) return this;if (a.nodeType || a === T) this[0] = a, this.length = 1;else for (o = this.length = a.length; r < o; r++) {
      this[r] = a[r];
    }return this;
  }function s(t, e) {
    return new n(t, e);
  ...
  }();s.prefixedProp = N, s.camelCase = z, j.extend({ css: function css(t, e) {
      if (A(t)) return t = N(t), arguments.length > 1 ? this.each(function (i) {
        return i.style[t] = e;
      }) : T.getComputedStyle(this[0])[t];for (var i in t) {
        this.css(i, t[i]);
      }return this;
    ...
    } });var V = O.documentElement;return j.extend({ position: function position() {
  ...
  return M;
}) : "undefined" == typeof exports || exports.nodeType || ("undefined" != typeof module && !module.nodeType && module.exports && (exports = module.exports = M), exports.default = M), M.keys = { TAB: 9, ENTER: 13, ESC: 27, ARROW_UP: 38, ARROW_DOWN: 40 }, M.tabPressed = !1;var docHandleKeydown = function docHandleKeydown(t) {
...
}, "es6-impl", "es3");var $jscomp$this = undefined;!function (t) {
  M.anime = t();
}(function () {
  function t(t) {
    if (!H.col(t)) try {
  ...
  var e = { data: {}, limit: 1 / 0, onAutocomplete: null, minLength: 1, sortFunction: function sortFunction(t, e, i) {
    ...
    function n(e, i) {
      ...
      } }, { key: "_handleContainerMousedownAndTouchstart", value: function value(e) {
  ...
  var e = { data: [], placeholder: "", secondaryPlaceholder: "", autocompleteOptions: {}, limit: 1 / 0, onChipAdd: null, onChipSelect: null, onChipDelete: null },
    ...
    }return _inherits(n, Component), _createClass(n, [{ key: "getData", value: function value() {
      ...
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));s.el.M_Datepicker = s, s.options = t.extend({}, n.defaults, i), i && i.hasOwnProperty("i18n") && "object" == _typeof(i.i18n) && (s.options.i18n = t.extend({}, n.defaults.i18n, i.i18n)), s.options.minDate && s.options.minDate.setHours(0, 0, 0, 0), s.options.maxDate && s.options.maxDate.setHours(0, 0, 0, 0), s.id = M.guid(), s._setupVariables(), s._insertHTMLIntoDOM(), s._setupModal(), s._setupEventHandlers(), s.options.defaultDate || (s.options.defaultDate = new Date(Date.parse(s.el.value)), s.options.setDefaultDate = !0);var o = s.options.defaultDate;return n._isDate(o) ? s.options.setDefaultDate ? s.setDate(o, !0) : s.gotoDate(o) : s.gotoDate(new Date()), s.isOpen = !1, s;
        ...
        if (this.isOpen || t) {
          var e = this.options,
              ...
              o = e.maxMonth,
              a = "",
              r = void 0;this._y <= i && (this._y = i, !isNaN(s) && this._m < s && (this._m = s)), this._y >= n && (this._y = n, !isNaN(o) && this._m > o && (this._m = o)), r = "pika-title-" + Math.random().toString(36).replace(/[^a-z]+/g, "").substr(0, 2);for (var l = 0; l < 1; l++) {
  ...
  var e = { dialRadius: 135, outerRadius: 105, innerRadius: 70, tickRadius: 20, duration: 350, container: null, defaultTime: "now", fromNow: 0, showClearBtn: !1, i18n: { cancel: "Cancel", clear: "Clear", done: "Ok" }, autoClose: !1, twelveHour: !0, vibrate: !0 },
    ...
    function n(e, i) {
      _classCallCheck(this, n);var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));return s.el.M_Timepicker = s, s.options = t.extend({}, n.defaults, i), s.id = M.guid(), s._insertHTMLIntoDOM(), s._setupModal(), s._setupVariables(), s._setupEventHandlers(), s._clockSetup(), s._pickerSetup(), s;
        ...
        var t = this;this.modal = M.Modal.init(this.modalEl, { onCloseEnd: function onCloseEnd() {
            t.isOpen = !1;
          } });
      } }, { key: "_setupVariables", value: function value() {
  ...
  var i = {},
    ...
    function s(e, i) {
      ...
      } }, { key: "_handleRangeFocus", value: function value() {
