  ...
  var Datepicker = function (_Component) {
    ...
    function Datepicker(el, options) {
      ...
      if (_this.options.minDate) {
        if (typeof _this.options.minDate == 'string') _this.options.minDate = new Date(_this.options.minDate);
        _this.options.minDate.setHours(0, 0, 0, 0);
      }
      if (_this.options.maxDate) {
        if (typeof _this.options.maxDate == 'string') _this.options.maxDate = new Date(_this.options.maxDate);
        _this.options.maxDate.setHours(0, 0, 0, 0);
      }
